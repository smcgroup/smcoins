...
public:
    ...
    {
        // Smcoins: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Smcoins: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Smcoins: two types of block: proof-of-work or proof-of-stake
    ...
    // Smcoins: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Smcoins: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Smcoins: block index flags
    enum  
    {
