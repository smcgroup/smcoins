...
const QString BITCOIN_IPC_PREFIX("Smcoins:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Smcoins: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Smcoins: click-to-pay handler");
    else
...
{
    // clicking on Smcoins: URLs creates FileOpen events on the Mac:
